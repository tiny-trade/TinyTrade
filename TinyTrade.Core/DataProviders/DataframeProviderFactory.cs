...
public static class DataframeProviderFactory
{
    ...
    public static ParallelBacktestDataframeProvider GetParallelBacktestDataframeProvider(TimeInterval interval, Pair pair, Timeframe timeframe, int batchCount)
        => new ParallelBacktestDataframeProvider(interval, pair, timeframe, batchCount);
